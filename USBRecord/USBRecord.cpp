...
int main()
{
   ...
   // int frame_width[CAM_NUM]={0}; 
   // int frame_height[CAM_NUM]={0}; 
	int frame_height = camCaptures[0].get(CAP_PROP_FRAME_HEIGHT); 
	int frame_width = camCaptures[0].get(CAP_PROP_FRAME_WIDTH);
